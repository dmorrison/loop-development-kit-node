...
proto.proto.KeyboardHotkey.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.proto.KeyboardModifiers.serializeBinaryToWriter
    );
  }
};
...
proto.proto.KeyboardHotkey.prototype.getModifiers = function() {
  return /** @type{?proto.proto.KeyboardModifiers} */ (
    jspb.Message.getWrapperField(this, proto.proto.KeyboardModifiers, 2));
};
