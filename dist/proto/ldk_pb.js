...
proto.proto.Whisper.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getStyle();
    if (f != null) {
        writer.writeMessage(4, f, proto.proto.Style.serializeBinaryToWriter);
    }
};
/**
...
proto.proto.Whisper.prototype.getStyle = function () {
    return /** @type{?proto.proto.Style} */ (jspb.Message.getWrapperField(this, proto.proto.Style, 4));
};
/**
...
proto.proto.OnEventRequest.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getSource();
    if (f != null) {
        writer.writeMessage(2, f, proto.proto.Source.serializeBinaryToWriter);
    }
};
/**
...
proto.proto.OnEventRequest.prototype.getSource = function () {
    return /** @type{?proto.proto.Source} */ (jspb.Message.getWrapperField(this, proto.proto.Source, 2));
};
/**
...
proto.proto.EmitWhisperRequest.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, proto.proto.Whisper.serializeBinaryToWriter);
    }
};
/**
...
proto.proto.EmitWhisperRequest.prototype.getWhisper = function () {
    return /** @type{?proto.proto.Whisper} */ (jspb.Message.getWrapperField(this, proto.proto.Whisper, 1));
};
/**
...
proto.proto.UpdateWhisperRequest.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getWhisper();
    if (f != null) {
        writer.writeMessage(2, f, proto.proto.Whisper.serializeBinaryToWriter);
    }
};
/**
 * optional string id = 1;
...
proto.proto.UpdateWhisperRequest.prototype.getWhisper = function () {
    return /** @type{?proto.proto.Whisper} */ (jspb.Message.getWrapperField(this, proto.proto.Whisper, 2));
};
/**
 * @param {?proto.proto.Whisper|undefined} value
 * @return {!proto.proto.UpdateWhisperRequest} returns this
