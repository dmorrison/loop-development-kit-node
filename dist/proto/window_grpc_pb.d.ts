export namespace WindowService {
    ...
    namespace windowWindows {
        ...
        const responseType_2: typeof import("./window_pb.js").WindowWindowsResponse;
        export { responseType_2 as responseType };
        export { serialize_google_protobuf_Empty as requestSerialize };
        export { deserialize_google_protobuf_Empty as requestDeserialize };
        export { serialize_proto_WindowWindowsResponse as responseSerialize };
        export { deserialize_proto_WindowWindowsResponse as responseDeserialize };
    }
    namespace windowWindowsStream {
        const path_3: string;
        ...
        const responseType_3: typeof import("./window_pb.js").WindowWindowsStreamResponse;
        export { responseType_3 as responseType };
        export { serialize_google_protobuf_Empty as requestSerialize };
        export { deserialize_google_protobuf_Empty as requestDeserialize };
        export { serialize_proto_WindowWindowsStreamResponse as responseSerialize };
        export { deserialize_proto_WindowWindowsStreamResponse as responseDeserialize };
    }
}
...
declare function serialize_proto_WindowWindowsResponse(arg: any): Buffer;
declare function deserialize_proto_WindowWindowsResponse(buffer_arg: any): import("./window_pb.js").WindowWindowsResponse;
declare function serialize_proto_WindowWindowsStreamResponse(arg: any): Buffer;
declare function deserialize_proto_WindowWindowsStreamResponse(buffer_arg: any): import("./window_pb.js").WindowWindowsStreamResponse;
export {};
