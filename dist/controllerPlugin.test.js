...
const mockedGrpc = utils_1.mocked(controllerGrpcServer_1.default);
...
describe('ControllerPlugin', () => {
    ...
    describe('constructor', () => {
        it('consumes the mocked module', () => {
            plugin = new controllerPlugin_1.default({});
            expect(controllerGrpcServer_1.default).toHaveBeenCalledTimes(1);
