...
export declare type Request<TRequestType = Messages.Empty, TResponseType = Messages.Empty> = (request: TRequestType, callback: (error: grpc.ServiceError | null, response: TResponseType) => void) => void;
/**
 * @internal
 */
