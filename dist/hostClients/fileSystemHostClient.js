...
function parseFileAction(action) {
    switch (action) {
        case filesystem_pb_1.FileAction.FILE_ACTION_CREATE:
            return filesystemHost_1.FileSystemStreamAction.Create;
        case filesystem_pb_1.FileAction.FILE_ACTION_WRITE:
            return filesystemHost_1.FileSystemStreamAction.Write;
        case filesystem_pb_1.FileAction.FILE_ACTION_REMOVE:
            return filesystemHost_1.FileSystemStreamAction.Remove;
        case filesystem_pb_1.FileAction.FILE_ACTION_RENAME:
            return filesystemHost_1.FileSystemStreamAction.Rename;
        case filesystem_pb_1.FileAction.FILE_ACTION_CHMOD:
            return filesystemHost_1.FileSystemStreamAction.Chmod;
        case filesystem_pb_1.FileAction.FILE_ACTION_UNKNOWN:
        default:
            return filesystemHost_1.FileSystemStreamAction.Unknown;
    }
}
/**
 * @param fileInfo
...
exports.FileSystemHostClient = FileSystemHostClient;
